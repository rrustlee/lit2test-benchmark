...
- Reference ordering under audit: `GPT 5.2 > Claude-Sonnet-4.6-hq > GLM-5 > DeepSeek-V3.2`
...
|---|---:|---:|---:|---:|
| `GPT 5.2 \| Claude-Sonnet-4.6-hq` | GPT 5.2 90 | Claude-Sonnet-4.6-hq 38 | 72 | 200 |
| `GPT 5.2 \| GLM-5` | GPT 5.2 154 | GLM-5 7 | 39 | 200 |
| `GPT 5.2 \| DeepSeek-V3.2` | GPT 5.2 180 | DeepSeek-V3.2 4 | 16 | 200 |
| `GLM-5 \| Claude-Sonnet-4.6-hq` | Claude-Sonnet-4.6-hq 143 | GLM-5 18 | 39 | 200 |
| `GLM-5 \| DeepSeek-V3.2` | GLM-5 93 | DeepSeek-V3.2 46 | 61 | 200 |
| `DeepSeek-V3.2 \| Claude-Sonnet-4.6-hq` | Claude-Sonnet-4.6-hq 166 | DeepSeek-V3.2 11 | 23 | 200 |
...
|---|---:|---:|---|---:|
| `GPT 5.2 \| Claude-Sonnet-4.6-hq` | 126.0 | 74.0 | GPT 5.2 | +52.0 |
| `GPT 5.2 \| GLM-5` | 173.5 | 26.5 | GPT 5.2 | +147.0 |
| `GPT 5.2 \| DeepSeek-V3.2` | 188.0 | 12.0 | GPT 5.2 | +176.0 |
| `GLM-5 \| Claude-Sonnet-4.6-hq` | 162.5 | 37.5 | Claude-Sonnet-4.6-hq | +125.0 |
| `GLM-5 \| DeepSeek-V3.2` | 123.5 | 76.5 | GLM-5 | +47.0 |
| `DeepSeek-V3.2 \| Claude-Sonnet-4.6-hq` | 177.5 | 22.5 | Claude-Sonnet-4.6-hq | +155.0 |

- Condorcet: beat counts `{GPT 5.2: 3, Claude-Sonnet-4.6-hq: 2, GLM-5: 1, DeepSeek-V3.2: 0}`; winner `GPT 5.2`; transitive, no cycle.
- Folded BT centered log abilities: GPT 5.2 `1.2709`, Claude-Sonnet-4.6-hq `0.7458`, GLM-5 `-0.7347`, DeepSeek-V3.2 `-1.2821`.
- BT ranking: `GPT 5.2 > Claude-Sonnet-4.6-hq > GLM-5 > DeepSeek-V3.2`.
...
|---|---:|---:|---:|---|
| `GPT 5.2 \| Claude-Sonnet-4.6-hq` | 90 | 110 | **-20** | **yes** |
| `GLM-5 \| DeepSeek-V3.2` | 93 | 107 | **-14** | **yes** |
| `GLM-5 \| Claude-Sonnet-4.6-hq` | 143 | 57 | +86 | no |
| `GPT 5.2 \| GLM-5` | 154 | 46 | +108 | no |
| `DeepSeek-V3.2 \| Claude-Sonnet-4.6-hq` | 166 | 34 | +132 | no |
| `GPT 5.2 \| DeepSeek-V3.2` | 180 | 20 | +160 | no |

- **Two pairwise relations flip**: `GPT 5.2 vs Claude-Sonnet-4.6-hq` (90 vs 110) and `GLM-5 vs DeepSeek-V3.2` (93 vs 107). Relative to the Scheme-A baseline (all sensitive cases as ties), the GPT-Claude majority inverts once >= 53 of its 72 sensitive cases are awarded to Claude-Sonnet-4.6-hq, and the GLM-DeepSeek majority inverts once >= 48 of its 61 sensitive cases are awarded to DeepSeek-V3.2. These are the two most fragile pairs.
- Adversarial Condorcet: beat counts `{Claude-Sonnet-4.6-hq: 3, GPT 5.2: 2, DeepSeek-V3.2: 1, GLM-5: 0}`; winner `Claude-Sonnet-4.6-hq`; ranking `Claude-Sonnet-4.6-hq > GPT 5.2 > DeepSeek-V3.2 > GLM-5` (transitive, no cycle).
- Adversarial folded BT (margin-weighted over all six pairs): GPT 5.2 `0.7221`, Claude-Sonnet-4.6-hq `0.6914`, GLM-5 `-0.5991`, DeepSeek-V3.2 `-0.8144`; BT ranking stays `GPT 5.2 > Claude-Sonnet-4.6-hq > GLM-5 > DeepSeek-V3.2`, but the GPT-vs-Claude BT gap shrinks from `0.525` (Scheme A) to `0.031`.
...
- Full reference ordering `GPT 5.2 > Claude-Sonnet-4.6-hq > GLM-5 > DeepSeek-V3.2` recovered in `10000/10000` replicates (recovery rate `1.0000`).
- Rank distribution: `{GPT 5.2 > Claude-Sonnet-4.6-hq > GLM-5 > DeepSeek-V3.2: 10000}`.
...
- Scheme B (adversarial): four of six pairwise relations survive (minimum margin 86/200); the two adjacent pairs `GPT 5.2 | Claude-Sonnet-4.6-hq` (margin -20) and `GLM-5 | DeepSeek-V3.2` (margin -14) flip, and the adversarial Condorcet winner becomes Claude-Sonnet-4.6-hq.
